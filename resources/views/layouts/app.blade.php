...
<head>
    ...
    <title>{{ config('app.name', 'MY FORMS') }}</title>
...
<body style="background-color: #FFE9FF">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: #673AB7;">
            <div class="container">
